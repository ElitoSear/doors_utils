...
public class Raycast {
    ...
    public static BlockHitResult cast(Vec3d origin, Vec2f rotation, ServerWorld world){
        ...
        Vec3d rotationVectorExtended = rotationVector.multiply(Raycast.maximumDistance);
    ...
    public static Vec2f getRotationWhenCollided(Direction direction) {
    ...
    public static Vec3d moveForward(Vec3d position, Vec2f rotation, double distance) {
